...
#import "SlidingScrollViewController.h"
@interface SlidingScrollViewController ()

@end

@implementation SlidingScrollViewController
...
- (void)loadView {
    ...
    _pageControl = [[TTPageControl alloc] initWithFrame:CGRectMake(0,0, 200, 20)];
    ...
    _scrollView = [[TTScrollView alloc] initWithFrame:CGRectMake(0,20, self.view.bounds.size.width, 50)];
